...
<div class="container-fluid">
    ...
    <div class="card">
        <form action="/galeries/{{ $galery->id }}" method="post" enctype="multipart/form-data">
        @method('put')
        @csrf

            <input type="hidden" name="oldImage" value="{{ old('image', $galery->image) }}">

            <div class="card-body">
                <div class="row">
                    <div class="form-group col-6">
                        <label for="judul">Judul</label>
                        <input type="text" class="form-control" id="judul" name="title" value="{{ old('title', $galery->title) }}">
